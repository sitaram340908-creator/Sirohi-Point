...
export default function BusinessCatalogScreen() {
  ...
  // Calculate card widths from the catalog grid itself, not the full window.
  // The grid can be narrower than the window because of page padding and filters.
  const cardWidth = (width >= 1200 ? 'calc((100% - 48px) / 4)' : width >= 900 ? 'calc((100% - 32px) / 3)' : 'calc((100% - 16px) / 2)') as any;
